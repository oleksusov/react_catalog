                    ...
                    <div className="photos__box">
                      <ul className="photos__list">
                        {photosIndexes.map(photoId => (
                          <li key={photoId} className="photos__item">
                            <button
                              type="button"
                              key={photoId}
                  ...
                  <div className="details-page__actions actions">
                    ...
                    <ul className="actions__list">
                      {details?.colorsAvailable.map((color) => (
                        <li key={color} className="actions__color-item">
                          <Link
                            key={color}
                            to={{
                    ...
                    <ul className="actions__list">
                      {details?.capacityAvailable.map((capacity) => (
                        <li key={capacity} className="actions__capacity-item">
                          <Link
                            key={capacity}
                            to={{
                    ...
                    <ul className="about__blocks">
                      {details?.description.map(({ title, text }) => (
                        ...
                        >
                          ...
                          {text.map(pharagraph => (
                            <p key={pharagraph} className="about__description">
                              {pharagraph}
                            </p>
                          ))}
                        </li>
