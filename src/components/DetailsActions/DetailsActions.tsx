...
export const DetailsActions: React.FC<Props> = ({ details, product }) => {
  ...
  return (
    <>
      ...
      <ul className="actions__list actions__list--first">
        {details?.colorsAvailable.map((color) => {
          const backgroundColor = colors[color as keyof ColorsType];
          return (
            <li
              className="actions__color-item"
              key={color}
            >
              <Link
                to={{
      ...
      <ul className="actions__list">
        {details?.capacityAvailable.map((capacity) => (
          <li
            className="actions__capacity-item"
            key={capacity}
          >
            <Link
              to={{
